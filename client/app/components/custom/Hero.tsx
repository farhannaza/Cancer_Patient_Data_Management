  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <section id="about" className="py-20 bg-gray-900 rounded-t-3xl rounded-b-3xl">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center text-white">About OncologyChain</h2>
          <p className="text-lg mb-8 max-w-3xl mx-auto text-center text-gray-300">
