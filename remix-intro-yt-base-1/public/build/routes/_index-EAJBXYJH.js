...
function Hero() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("section", { className: "w-full min-h-screen py-12 md:py-24 lg:py-32", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "container px-4 md:px-6", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex flex-col items-center justify-center space-y-4 text-center", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "space-y-2", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h1", { className: "text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl/none my-8", children: "My First Remix App" }, void 0, false, {
        fileName: "app/components/custom/Hero.tsx",
        lineNumber: 27,
        columnNumber: 13
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400 pb-3", children: "Covering basic Remix concepts like routing, data fetching, and more.." }, void 0, false, {
        fileName: "app/components/custom/Hero.tsx",
        lineNumber: 30,
        columnNumber: 13
      }, this)
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1728403581917.3347";
}
var meta = () => {
  return [{
    title: "New Remix App"
...
//# sourceMappingURL=/build/routes/_index-EAJBXYJH.js.map
